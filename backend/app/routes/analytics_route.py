...
from app.models.transaction import UnifiedTransactionModel, TransactionModelForPivot
...
@router.get("/transactions", response_model=list[TransactionModelForPivot])
