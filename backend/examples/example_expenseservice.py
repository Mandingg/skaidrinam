...
def test_user_service():
    ...
    expense = ExpenseModel(user_id=userID, receipt_id=None, category_id=2, description="Testas", amount=20, expense_date="2026-02-01")
    ...
    expense2 = ExpenseModel(user_id=userID, receipt_id=None, category_id=3, description="Testas2", amount=0.5, expense_date="2026-03-01")
    ...
    all_expenses = expense_service.get_expenses_by_user(userID)
    print(f"Sėkmė! \nGautos išlaidos user_id={userID}: {all_expenses}")
